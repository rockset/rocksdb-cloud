...
int main() {
  ...
  // Connect the cloud environment instrumentation with a stats receiver.
  cloud_env_options.cloud_statistics = CreateCloudStatistics();
  ...
  // Connect the DB instrumentation with the cloud stats receiver.
  // This allows the statistics collected in the cloud environment to be shown
  // along with the database statistics in the logs during compaction operations.
  options.statistics = cloud_env_options.cloud_statistics;

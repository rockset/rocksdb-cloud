...
class CompactionPrepulateBlockCachePolicy {
public:
  virtual ~CompactionPrepulateBlockCachePolicy() = default;

  // Whether to prepoulate blocks of sst file generated by
  // compaction.  `props` is the table properties of the
  // newly generated sst file
  virtual bool shouldWarmCache(const TableProperties& props) = 0;
};
...
struct BlockBasedTableOptions {
  ...
  enum class PrepopulateBlockCache : char {
    ...
    // blocks of sst files follow `compaction_prepoulate_block_cache_policy`
    // are applied
    kFlushAndCompaction
  };
  ...
  // Policy on whether to prepopulate blocks generated by compaction.
  // Only apply when `prepopulate_block_cache=kFlushAndCompaction`
  std::shared_ptr<CompactionPrepulateBlockCachePolicy> compaction_prepoulate_block_cache_policy{nullptr};
};
